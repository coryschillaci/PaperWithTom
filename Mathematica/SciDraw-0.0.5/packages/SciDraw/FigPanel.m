...
UsedCanvasRegion,UsedPlotRange,BaseExteriorEdgeMask,DerivedExteriorEdgeMask,UsedExteriorEdgeMask,
...
(* derive plot range *)
UsedPlotRange=ExtendRegion[(PlotRange/.ResolvedCompositeOptions),(ExtendRange/.ResolvedCompositeOptions),Scaled];
If[
...
SetAttributes[ByPanelColumn,HoldFirst];
...
SetAttributes[ByPanelIndices,HoldFirst];
...
SetAttributes[ByPanelSequence,HoldFirst];
