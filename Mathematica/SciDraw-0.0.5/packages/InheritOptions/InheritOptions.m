...
Restructured to load from init.m file.  Add inheritance descriptor {parent,{option1\[Rule]value1,...},All} for override of specific defaults while inheriting all options.  Modify RealizeOptions to work also for symbol with no OptionInheritanceRules.  Undocument function GetAutoOption as unrelated to inheritance.
...
v2.02, June 12, 2013. Change fall-through pattern to use Except (dramatic performance improvement on long option lists).
*)
...
FullRule:((Option:Except[Alternatives@@KnownOptions[Object]]->Value_)|(Option:Except[Alternatives@@KnownOptions[Object]]:>Value_)):>Evaluate[$UnknownOption[Object,Option,FullRule]],
{}
]
};
