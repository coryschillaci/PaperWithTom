...
We point out that the structure of the spin-orbit term in relative coordinates in equation~\ref{eq:WeylHamiltonian} is exactly the form that appears in weak-interaction parity-violating proton-proton scattering\cite{Haxton:2013aca,deVries:2014vqa}.  As proton-proton scattering is intrinsically in the $^1S_0$ channel, its scattering length is an order of magnitude larger than its effective range.  The parity conserving part of the nuclear potential could therefore be represented by the contact interaction in equation~\ref{eq:WeylHamiltonian}.  The CM spin-orbit term (i.e. the last term in equation~\ref{eq:WeylHamiltonian}) seems to spoil the analogy. However, we will show later that the effect of this term on the ground state is negligible. 
