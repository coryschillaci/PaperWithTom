...
\begin{figure}
\includegraphics{Figures/WeylSpectrum}\caption{\label{fig:WeylSpectrum} Spectrum of states with total angular momentum $J=0$ for the Hamiltonian \eqref{eq:WeylHamiltonian}. The bottom left figure shows the ground state energy for $\tilde{a}_W=-1$ as function of $\tilde{\alpha}_W$, above are the first few excitation energies. The right figure shows the results for a positive scattering scattering length $\tilde{a}_W=\infty$.} 
\end{figure}
